...
class FirestoreRepository @javax.inject.Inject constructor() : IFirestoreRepository {
    ...
    override fun observeUserRecipes(userId: String): Flow<List<Recipe>> = callbackFlow {
        ...
        val listenerRegistration = query.addSnapshotListener { snapshot, error ->
            if (error != null) {
                // No borres la UI y no cierres el flow.
                // Solo loguea y conserva el último valor mostrado.
                android.util.Log.e("FirestoreRepository", "observeUserRecipes error", error)
